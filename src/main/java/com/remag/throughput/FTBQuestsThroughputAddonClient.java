...
@Mod(value = FTBQuestsThroughputAddon.MODID, dist = Dist.CLIENT)
// You can use EventBusSubscriber to automatically register all static methods in the class annotated with @SubscribeEvent
@EventBusSubscriber(modid = FTBQuestsThroughputAddon.MODID, value = Dist.CLIENT)
public class FTBQuestsThroughputAddonClient {
    public FTBQuestsThroughputAddonClient(ModContainer container) {
